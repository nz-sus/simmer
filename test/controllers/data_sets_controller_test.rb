...
class DataSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create data_set" do
    assert_difference("DataSet.count") do
      post data_sets_url, params: { data_set: { client_id: @data_set.client_id, description: @data_set.description, name: @data_set.name, time_range_end: @data_set.time_range_end, time_range_start: @data_set.time_range_start } }
    end
  ...
  test "should update data_set" do
    patch data_set_url(@data_set), params: { data_set: { client_id: @data_set.client_id, description: @data_set.description, name: @data_set.name, time_range_end: @data_set.time_range_end, time_range_start: @data_set.time_range_start } }
