...
class LogEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create log_entry" do
    assert_difference("LogEntry.count") do
      post log_entries_url, params: { log_entry: { data_json: @log_entry.data_json, data_schema: @log_entry.data_schema, data_set_id: @log_entry.data_set_id, timestamp: @log_entry.timestamp, title: @log_entry.title } }
    end
  ...
  test "should update log_entry" do
    patch log_entry_url(@log_entry), params: { log_entry: { data_json: @log_entry.data_json, data_schema: @log_entry.data_schema, data_set_id: @log_entry.data_set_id, timestamp: @log_entry.timestamp, title: @log_entry.title } }
