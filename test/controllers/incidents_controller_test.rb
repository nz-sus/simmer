...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference("Incident.count") do
      post incidents_url, params: { incident: { client_id: @incident.client_id, closed_at: @incident.closed_at, name: @incident.name, opened_at: @incident.opened_at } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { client_id: @incident.client_id, closed_at: @incident.closed_at, name: @incident.name, opened_at: @incident.opened_at } }
